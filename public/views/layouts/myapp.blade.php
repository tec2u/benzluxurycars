...
<head>
    ...
    <title>{{ config('app.name', 'Benz Luxury Rental') }}</title>
    {{-- jquery --}}
    ...
    <link rel="stylesheet" href="{{ asset('js/app.js') }}" type="text/css" />
    <style>
        html {
            ...
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800 ">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl drop-shadow-2xl">
                    ...
                    <a href="{{ route('home') }}" class="flex items-center">
                        <img loading="lazy" src="/logo_black.png" class="mr-3 h-12" alt="Flowbite Logo" />
                    </a>
                    ...
                    @if (Auth::user()->role == 'admin')
                        <div class="hidden justify-between mb-6 items-center w-full lg:flex lg:w-auto" id="mobile-menu-2">
                            <ul class="flex flex-col  font-medium lg:flex-row lg:space-x-8 lg:mt-0 ">
                                ...
                                <li>
                                    <a href="{{ route('allReservations') }}">
                                        <div class="group text-center">
                                            <div class="group-hover:cursor-pointer">Reservations</div>
                                            <div
                                                class="block invisible bg-pr-400 w-20 h-1 rounded-md text-center -bottom-1 mx-auto relative group-hover:visible">
                                            </div>
                                    </a>
            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    <div class="mb-12 md:mb-0 flex justify-center ">
                        <a href="" class="flex items-center">
                            <img loading="lazy" src="/logo.png" class="mr-3 h-24"
                                alt="Logo" />
                        </a>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        <div>
                            ...
                            <ul class=" text-gray-400">
                                <li class="mb-4">
                                    <a href="/cars" target='_blank'="hover:underline">Cars</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://wa.me/971505068032" class="hover:underline "
                                        target='_blank'>+971 0000 0000</a>
                                </li>
                                <li>
                                    <a href="/contact_us" class="hover:underline"
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2022 <a
                            ...
                            class="hover:underline">Benz Luxury Cars™</a>. All Rights Reserved.
                    </span>
