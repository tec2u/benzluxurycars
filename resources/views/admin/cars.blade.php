...
<div class="my-20 flex flex-col justify-center  items-center mx-auto max-w-screen-xl">
    <div class="flex">
        ...
        <form action="{{ route('cars.index') }}" class="ml-4" method="get">
            <div class="flex">
                <input type="text" name="search" value="{{ $search ?? '' }}" class="bg-pr-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pr-500 focus:border-pr-500 block w-full p-2.5" placeholder="search by model">
                <button class="p-3 ml-3 font-bold border rounded-md border-pr-400 text-pr-400 hover:text-white hover:bg-pr-400"> search </button>
            </div>
        </form>
    </div>
